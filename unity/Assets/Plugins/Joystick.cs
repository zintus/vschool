...
public class Joystick : MonoBehaviour{ 
    ...
    public void Start()
    {
		...
		positionOffset = new Vector2(Screen.width * transform.position.x, Screen.height * transform.position.y);
		defaultRect.x += positionOffset.x;
		defaultRect.y += positionOffset.y;
        ...
        {               
			...
			Debug.Log(guiBoundary.min);
			Debug.Log(guiBoundary.max);
        }
    }
    ...
    public void ResetJoystick()
    {
		...
		Rect originalLocation = defaultRect;
		originalLocation.x -= positionOffset.x;
		originalLocation.y -= positionOffset.y;
        gui.pixelInset = originalLocation;
    ...
    {   
            ...
            for(int i = 0;i < count; i++)
            {
                ...
                {   
                    ...
                    {                   
						...
						tmprect.x -= positionOffset.x;
						tmprect.y -= positionOffset.y;
        ...
        if ( !touchPad )
        {
            ...
            position.x = ( gui.pixelInset.x + 2 * guiTouchOffset.x ) / guiTouchOffset.x;
            position.y = ( gui.pixelInset.y + 2 * guiTouchOffset.y ) / guiTouchOffset.y;
